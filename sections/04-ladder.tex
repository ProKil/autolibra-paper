...
results.
%\diyi{do we want to summarize these improvement numbers in a table or something? Phil: Done in table 3}
...
improvement on WebVoyager, shown in Fig. \ref{fig:autolibra-training} \diyi{missing?} and Tab. \ref{tab:baba_wv_scores},
...
\diyi{the result of this paragraph is good, but it focuses too much on "how we did it", rather than the result explanation of whether autolibra led to optimization gains and why. }