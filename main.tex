...
task success or pre-defined designed metrics.
However, these metrics are often coarse and heavily rely on manual design from experts, making it difficult to evaluate agents' changing behaviors in action. 
...
Second, we show that AutoLibra can also iteratively selects high-quality fine-tuning data
