...
\title{AutoLibra \protect\includegraphics[height=1em]{figs/scale.png} \\ \textit{Metric Induction from Open-Ended Human Input for Agents}}
...
\begin{abstract}
Humans learn from the input of others in social interaction,
which is useful for us to self-reflect and shape future behaviors. 
Based on this intuition, we build \emph{AutoLibra},
...
in previous agent evaluation papers and discover the ones that are overlooked.
...
enhancing human-in-the-loop prompt engineering.
\end{abstract}
